import ConvectiveTurbulenceTheoremCanonicalLaneLean.AnalyticObjects
...
def mathlibPDESubstrate : MathlibPDESubstrate := {
  ...
  carriedBoundary := "Mathlib provides analytic substrate; the theorem-local turbulent convection closure is carried through admitted analytic certificate fields."
}
